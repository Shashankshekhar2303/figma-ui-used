...
const EventContent = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex-1 shadow-[0px_1px_2px_rgba(0,_0,_0,_0.12)] bg-white flex flex-col items-start justify-start pt-3 px-0 pb-5 box-border gap-[14px] max-w-full z-[1] text-left text-sm text-black font-ibm-plex-sans ${className}`}
    >
      <div className="self-stretch h-[374px] relative shadow-[0px_1px_2px_rgba(0,_0,_0,_0.12)] bg-white hidden" />
      <div className="self-stretch h-[120px] relative rounded-t rounded-b-none bg-[url('/public/rectangle-52@2x.png')] bg-cover bg-no-repeat bg-[top] z-[2]" />
