...
const SecondPostContent = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch shadow-[0px_1px_2px_rgba(0,_0,_0,_0.12)] bg-white flex flex-col items-start justify-start pt-0 px-0 pb-5 box-border gap-[14px] max-w-full z-[1] text-left text-sm text-black font-ibm-plex-sans ${className}`}
    >
...
SecondPostContent.propTypes = {
  className: PropTypes.string,
};

export default SecondPostContent;
